...
class DepartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create department" do
    assert_difference("Department.count") do
      post departments_url, params: { department: { college_id: @department.college_id, name: @department.name } }
    end
  ...
  test "should update department" do
    patch department_url(@department), params: { department: { college_id: @department.college_id, name: @department.name } }
